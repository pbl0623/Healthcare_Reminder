...
function triggerNotification(medicine) {
  ...
  // Start continuous vibration until confirmation
  if ("vibrate" in navigator) {
    stopVibration(); // Stop any previous vibration
    vibrationInterval = setInterval(() => navigator.vibrate([500, 200]), 1000); // Repeat vibration pattern
  }
